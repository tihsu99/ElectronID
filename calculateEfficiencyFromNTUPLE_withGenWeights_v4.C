...
void calculateEfficiencyFromNTUPLE_withGenWeights_v4(){
  ...
  TFile fi("/afs/cern.ch/user/r/rkamalie/workspace/public/DY_Run2Asympt25ns_miniAOD_sept18_flat_ntuple_withWeights.root");   
  gDirectory->ls();
  TTree *tr          = (TTree*)gDirectory->Get("electronTree");

  TFile fiBG("/afs/cern.ch/user/r/rkamalie/workspace/public/TT_Run2Asympt25ns_miniAOD_sept21_flat_ntuple_withWeights.root");   
  gDirectory->ls();
