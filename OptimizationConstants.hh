...
namespace Opt {
  ...
  const TString fnameSignal = "/afs/cern.ch/user/r/rkamalie/workspace/public/reweight29sept_v10.root";
  const TString signalTreeName = "electronTree_S";
  const TString fnameBackground = "/afs/cern.ch/user/r/rkamalie/workspace/public/reweight29sept_v10.root";
